...
type MakeResultEventFunc func(wrapped *output2.InternalWrappedEvent) []*output2.ResultEvent

// RequestData contains data for a request event
type RequestData struct {
	MakeResultFunc MakeResultEventFunc
	Event          *output2.InternalWrappedEvent
	Operators      *operators2.Operators
	MatchFunc      operators2.MatchFunc
	ExtractFunc    operators2.ExtractFunc
}
...
// data part matchers.
func HasMatchers(op *operators2.Operators) bool {
	if op == nil {
		return false
	}
