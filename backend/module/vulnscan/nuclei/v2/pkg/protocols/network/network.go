...
type Request struct {
	...
	generator  *generators2.Generator
...
func (r *Request) Compile(options *protocols2.ExecuterOptions) error {
	...
	for _, input := range r.Inputs {
		...
		if compiled, evalErr := expressions2.Evaluate(input.Data, map[string]interface{}{}); evalErr == nil {
			input.Data = compiled
		}
	}
	...
	client, err := networkclientpool2.Get(options.Options, &networkclientpool2.Configuration{})
	if err != nil {
