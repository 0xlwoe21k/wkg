...
func GetRawHTTP(options *types2.Options) *rawhttp.Client {
...
func Get(options *types2.Options, configuration *Configuration) (*retryablehttp.Client, error) {
...
func wrappedGet(options *types2.Options, configuration *Configuration) (*retryablehttp.Client, error) {
