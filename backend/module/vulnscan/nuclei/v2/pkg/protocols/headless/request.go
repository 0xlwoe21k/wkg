...
func (r *Request) ExecuteWithResults(input string, metadata, previous output2.InternalEvent /*TODO review unused parameter*/, callback protocols2.OutputEventCallback) error {
