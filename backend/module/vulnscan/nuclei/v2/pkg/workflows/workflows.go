...
type Workflow struct {
	...
	Options *protocols2.ExecuterOptions `yaml:"-"`
}
...
type WorkflowTemplate struct {
	...
	Tags stringslice2.StringSlice `yaml:"tags,omitempty" jsonschema:"title=tags to execute,description=Tags to run template based on"`
	// description: |
