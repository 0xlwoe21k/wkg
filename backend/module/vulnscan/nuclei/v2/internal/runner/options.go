...
func ParseOptions(options *types2.Options) {
	...
	if options.TemplatesVersion {
		configuration, err := config2.ReadConfiguration()
		if err != nil {
	...
	err := protocolinit2.Init(options)
	if err != nil {
...
func validateOptions(options *types2.Options) error {
...
func configureOutput(options *types2.Options) {
...
func loadResolvers(options *types2.Options) {
